...
class conector_pg
{
    ...
    function __construct($host='localhost', $bd='mascotas', $user='mascotas_usr', $pass='7j4c6fu8sr')
    {
    ...
    function consultar($sql)
        ...
        //establecemos el link
         ...
         $link = pg_connect($datos_bd) or die('falla en la conexion de la base de datos !!');
        ...
        if(!$query) 
        echo $sql;
        //si no ejecuta la consulta imprimo el sql que llega solo cuando hacemos pruebas
        return $query;
    }
